...
class TestOpenHandsApp:
    ...
    @mock.patch("openhands_cli.refactor.textual_app.get_welcome_message")
    def test_on_mount_adds_welcome_message(self, mock_welcome):
        ...
        def mock_query_one(selector, widget_type=None):
            if selector == "#main_display":
                return mock_richlog
            elif selector == "#user_input":
                return mock_input
        ...
        # Verify welcome message was written to RichLog
        mock_richlog.write.assert_called_once_with(welcome_text)
    ...
    async def test_input_functionality_integration(self, mock_welcome):
        ...
        async with app.run_test() as pilot:
            ...
            # We can't easily check the exact content, but we can verify it's not empty

    @mock.patch("openhands_cli.refactor.textual_app.get_welcome_message")
    def test_welcome_message_called_on_mount(self, mock_welcome):
        ...
        # Verify get_welcome_message was called
